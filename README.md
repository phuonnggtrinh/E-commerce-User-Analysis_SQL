...
**a. Query 01: calculate total visit, pageview, and transaction for Jan, Feb and March 2017 (order by month)**
...
**b. Query 02: Bounce rate per traffic source in July 2017**
...
**c. Query 3: Revenue by traffic source by week, by month in June 2017**
...
**d. Query 04: Average number of product pageviews by purchaser type (purchasers vs non-purchasers) in June, July 2017**
* **SQL Code**
...
**e. Query 05: Average number of transactions per user that purchased in July 2017**
* **SQL Code**
...
**f. Query 06: Average amount of money spent per session. Only include purchaser data in July 2017**
* **SQL Code**
...
**g. Query 07: Other products purchased by customers who purchased product "YouTube Men's Vintage Henley" in July 2017. Output should show product name and the quantity was ordered.**
* **SQL Code**
...
**h. Query 08: Calculate cohort map from product view to add to cart to purchase in Jan, Feb and March 2017.**
* **SQL Code**
